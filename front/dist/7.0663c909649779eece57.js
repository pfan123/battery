...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-e8a89a1a","hasScoped":false,"preserveWhitespace":false,"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./front/src/views/NewsArticles.vue
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"news_wrapper"},[(_vm.banners.length > 1)?_c('div',[_c('bat-banner',{attrs:{"banners":_vm.banners}})],1):_c('div',[_c('bat-image',{attrs:{"v:if":"banners.length == 1","image":_vm.banners[0]}})],1),_c('div',{staticClass:"news_article"},[_c('div',{staticClass:"news_article_title"},[_vm._v(_vm._s(_vm.isEnglish ? _vm.article.ftitle : _vm.article.title))]),_c('p',{staticClass:"news_article_date"},[_vm._v("发表时间："+_vm._s(_vm.article.date))]),_c('div',{staticClass:"news_article_content",domProps:{"innerHTML":_vm._s(_vm.isEnglish ? _vm.article.fcontent : _vm.article.content)}})])])}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
